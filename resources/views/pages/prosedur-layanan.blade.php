            ...
            <div class="card-body p-4 p-lg-5">
              <div class="tab-content" id="v-pills-tabContent">
                  ...
                  <ul class="nav nav-tabs mb-3" id="innerTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link"
                              id="khusus-tab"
                              data-bs-toggle="tab"
                              data-bs-target="#khusus"
                              type="button"
                              role="tab"
                              aria-controls="khusus"
                              aria-selected="false">
                        Prosedur Khusus
                      </button>
                    </li>
                  ...
                  <div class="tab-content" id="innerTabContent">
                    ...
                    <div class="tab-pane fade show active"
                      ...
                      <div class="fw-normal text-muted">
                        ...
                        <div class="text-center py-2">
                          <img src="{{ asset('img/prosedur-biasa.png') }}"
                               alt="Prosedur biasa permintaan informasi"
                    ...
                    <div class="tab-pane fade"
                      ...
                      <div class="fw-normal text-muted">
                        ...
                        <div class="text-center py-2">
                          <img src="{{ asset('img/prosedur-khusus.png') }}"
                               alt="Prosedur khusus permintaan informasi"
                               class="img-fluid rounded-3 border" />
                        </div>
                ...
                <div class="tab-pane fade"
                  ...
                  <div class="fw-normal text-muted">
                    <h5 class="fw-semibold">Syarat dan Prosedur Pengajuan:</h5>
                    <ol class="mb-0">
                      <li>
                ...
                <div class="tab-pane fade"
                  ...
                  <div class="text-center py-2">
                    <img src="{{ asset('img/prosedur-sengketa.png') }}"
                         alt="Prosedur sengketa"
                         class="img-fluid rounded-3 border" />
                  </div>
                </div>
