<!-- Header-->
   <header class="bg-dark position-relative" style="min-height: 40vh; overflow: hidden;">
        <!-- Background -->
        <div class="position-absolute top-0 start-0 w-100 h-100 z-0">
            <img class="img-fluid w-100 h-100 object-fit-cover" src="{{ asset('img/home-kantor.jpg') }}" alt="..." style="object-fit: cover;" />
