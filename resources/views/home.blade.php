                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <p class="card-text mb-0">Ajukan keberatan Anda jika permohonan informasi tidak ditanggapi sebagaimana mestinya.</p>
                                </div>
                                <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
        ...
        <div class="container px-5 my-5">
            <div class="row gx-5">
                ...
                <div class="col-lg-8">
                    ...
                    <a href="prosedur-layanan" class="text-decoration-none text-reset">
                    ...
                    <a href="informasi-berkala" class="text-decoration-none text-reset">
                        <div class="col mb-5 h-100 feature-box">
                    ...
                    <a href="informasi-tersedia-setiap-saat" class="text-decoration-none text-reset">
                        <div class="col mb-5 h-100 feature-box">
                    ...
                    <a href="informasi-dikecualikan" class="text-decoration-none text-reset">
                        <div class="col mb-5 h-100 feature-box">
